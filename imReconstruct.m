...
main_image = im2double(imread('/Users/vesna/Documents/ETH/Thesis/Code/aggregates/PAT10-1317-DYEfsb-series-28-agg-1.png'));
max_aggregate_size = 726; %this is the max size of aggregates in the folder
...
Rads = precomputeZernikeBasis(N, max_zernike_deg);
Z = zernikeUsingPrecomputed(Rads, im, max_zernike_deg);
